...
function sortGroupedProducts(grouped) {
  Object.keys(grouped).forEach(category => {
    grouped[category] = grouped[category].sort((a, b) => b.rating - a.rating);
  });
  return grouped;
}

function groupAndSortProductsFinal(products) {
...
const groupedAndSortedProducts = groupAndSortProductsFinal(products);
